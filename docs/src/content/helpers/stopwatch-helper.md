---
title: "StopwatchHelper"
description: "是一个静态帮助类，为性能测量和计时提供了丰富的功能，包括基础计时、高精度计时、多次执行统计、条件计时、范围计时、基准测试、时间格式化等，旨在简化性能测量和计时的开发工作，提供友好的时间格式化输出。"
namespace: "Chet.Utils.Helpers"
className: "StopwatchHelper"
category: "Helpers"
order: 7
---
